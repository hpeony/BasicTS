...
MODEL_PARAM = {
    ...
    # "external_memory_S": 40,            # 外部记忆单元的大小
    # =======================================================
}
NUM_EPOCHS = 120
...
# Learning rate scheduler settings
CFG.TRAIN.LR_SCHEDULER = EasyDict()
CFG.TRAIN.LR_SCHEDULER.TYPE = "CosineAnnealingWarmRestarts"
CFG.TRAIN.LR_SCHEDULER.PARAM = {
    "T_0": 15,       # 第一个周期的长度是 10 个 epochs。
    "T_mult": 2,     # 后续每个周期的长度都是前一个的2倍。
